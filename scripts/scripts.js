...
// 3.if modelName is currently "CPRG", duration * 213 gives us the new total cost.
    else {
...
// 1. create a variable to represent the "Switch Model" pseudo-button
let modelButton = document.getElementById("model-button");

// 2.create a function called changeModel()
...
// 2.create a function called changeDuration()
